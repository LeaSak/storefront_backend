    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, store.update(parseInt(req.params.id), product)];
            case 1:
                updated = _a.sent();
                res.json(updated);
                return [3 /*break*/, 3];
...
productsRouter.post('/', verifyAuthToken_1["default"], create);
productsRouter["delete"]('/:id', verifyAuthToken_1["default"], destroy);
productsRouter.put('/:id', verifyAuthToken_1["default"], update);
