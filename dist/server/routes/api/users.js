...
userRouter.get('/', verifyAuthToken_1["default"], index);
userRouter.get('/:id', verifyAuthToken_1["default"], show);
userRouter.post('/', create);
userRouter.put('/:id', verifyAuthToken_1["default"], update);
userRouter["delete"]('/:id', verifyAuthToken_1["default"], destroy);
